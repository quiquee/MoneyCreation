export const dashboard = {
    ...
    drawchart: function(id, fData) {
        ...
        fData.forEach(function(d) {
            d.total = d.bs.low + d.bs.mid + d.bs.high;
        });
            ...
            function mouseover(d) {
                ...
                hG.update(
                    fData.map(function(v) {
                        return [v.Ledger, v.bs[d.data.type]];
                    }),
        ...
        var tF = ["Tokens", "Bitcoins", "Cash", "Current Account"].map(function(d) {
            return {
                type: d,
                freq: d3.sum(
